    ...
    DWORD_PTR Parameter2)
{
    ...
    switch ( Message )
    {
        ...
        case AUXM_INIT:
        {
            Result = WdmAudAddRemoveDeviceNode(AUX_DEVICE_TYPE, (LPCWSTR)Parameter2, TRUE);
            break;
        }

        case DRVM_EXIT:
        {
            Result = WdmAudAddRemoveDeviceNode(AUX_DEVICE_TYPE, (LPCWSTR)Parameter2, FALSE);
            break;
        }
#endif
        ...
        {
            Result = MmeGetNumDevs(AUX_DEVICE_TYPE, (LPCWSTR)Parameter1);
            break;
        }
