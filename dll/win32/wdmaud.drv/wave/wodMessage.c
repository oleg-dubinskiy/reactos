    ...
    DWORD_PTR Parameter2)
{
    ...
    switch ( Message )
    {
        ...
        case WODM_INIT:
        {
            Result = WdmAudAddRemoveDeviceNode(WAVE_OUT_DEVICE_TYPE, (LPCWSTR)Parameter2, TRUE);
            break;
        }

        case DRVM_EXIT:
        {
            Result = WdmAudAddRemoveDeviceNode(WAVE_OUT_DEVICE_TYPE, (LPCWSTR)Parameter2, FALSE);
            break;
        }
#endif
        ...
        {
            Result = MmeGetNumDevs(WAVE_OUT_DEVICE_TYPE, (LPCWSTR)Parameter1);
            break;
        }
