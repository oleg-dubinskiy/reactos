    ...
    DWORD_PTR Parameter2)
{
    ...
    switch ( Message )
    {
        ...
        case WIDM_INIT:
        {
            Result = WdmAudAddRemoveDeviceNode(WAVE_IN_DEVICE_TYPE, (LPCWSTR)Parameter2, TRUE);
            break;
        }

        case DRVM_EXIT:
        {
            Result = WdmAudAddRemoveDeviceNode(WAVE_IN_DEVICE_TYPE, (LPCWSTR)Parameter2, FALSE);
            break;
        }
#endif
        case WIDM_GETNUMDEVS :
        {
            Result = MmeGetNumDevs(WAVE_IN_DEVICE_TYPE, (LPCWSTR)Parameter1);
            break;
        }
