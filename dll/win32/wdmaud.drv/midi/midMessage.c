    ...
    DWORD_PTR Parameter2)
{
    ...
    switch ( Message )
    {
        ...
        case MIDM_INIT:
        {
            Result = WdmAudAddRemoveDeviceNode(MIDI_IN_DEVICE_TYPE, (LPCWSTR)Parameter2, TRUE);
            break;
        }

        case DRVM_EXIT:
        {
            Result = WdmAudAddRemoveDeviceNode(MIDI_IN_DEVICE_TYPE, (LPCWSTR)Parameter2, FALSE);
            break;
        }
#endif
        ...
        {
            Result = MmeGetNumDevs(MIDI_IN_DEVICE_TYPE, (LPCWSTR)Parameter1);
            break;
        }
