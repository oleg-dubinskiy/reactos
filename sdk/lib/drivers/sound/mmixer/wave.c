    ...
    OUT LPWAVEINCAPSW Caps)
{
    ...
    /* store channel count */
    WaveInCaps.wChannels = WaveInfo->DataRangeAudio->MaximumChannels;

    /* get all supported formats */
    MMixerCheckFormat(WaveInfo->DataRangeAudio, &WaveInCaps.dwFormats);
    ...
    OUT LPWAVEOUTCAPSW Caps)
{
    ...
    /* store channel count */
    WaveOutCaps.wChannels = WaveInfo->DataRangeAudio->MaximumChannels;

    /* get all supported formats */
    MMixerCheckFormat(WaveInfo->DataRangeAudio, &WaveOutCaps.dwFormats);
