...
#else
  #define MI_MAKE_DIRTY_PAGE(x)      ((x)->u.Hard.Dirty = 1, (x)->u.Hard.Writable = 1)
  #define MI_MAKE_CLEAN_PAGE(x)      ((x)->u.Hard.Dirty = 0, (x)->u.Hard.Writable = 0)
#endif
#define MI_MAKE_ACCESSED_PAGE(x)     ((x)->u.Hard.Accessed = 1)
#define MI_PAGE_DISABLE_CACHE(x)     ((x)->u.Hard.CacheDisable = 1)
#define MI_PAGE_NO_DISABLE_CACHE(x)  ((x)->u.Hard.CacheDisable = 0)
...
#ifndef _X86PAE_
  #define MI_USED_PAGE_TABLES_MAX  768  // (PDE_PER_SYSTEM * 3 / 4) // (1024 * 3 / 4)
#else
  #define MI_USED_PAGE_TABLES_MAX  1536 // (PDE_PER_SYSTEM * 3 / 4) // ((4 * 512) * 3 / 4)
#endif
