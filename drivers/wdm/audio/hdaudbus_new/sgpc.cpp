...
NTSTATUS NTAPI HDAGraphics_EvtIoTargetQueryRemove(
...
void NTAPI HDAGraphics_EvtIoTargetRemoveCanceled(
    WDFIOTARGET ioTarget
) {
...
void NTAPI HDAGraphics_EvtIoTargetRemoveComplete(
    WDFIOTARGET ioTarget
) {
    PFDO_CONTEXT fdoCtx;
    SklHdAudBusPrint(DEBUG_LEVEL_INFO, DBG_INIT,
...
void NTAPI HDAGraphicsPowerNotificationCallback(
...
void NTAPI HDAGraphicsPowerRemovalNotificationCallback(
    PVOID GraphicsDeviceHandle,
    PVOID PrivateHandle
) {
    PFDO_CONTEXT fdoCtx = (PFDO_CONTEXT)PrivateHandle;
...
void NTAPI HDAGraphicsPowerFStateNotificationCallback(
    PVOID GraphicsDeviceHandle,
...
void NTAPI HDAGraphicsPowerInitialComponentStateCallback( //https://learn.microsoft.com/en-us/windows-hardware/drivers/ddi/d3dkmthk/nc-d3dkmthk-pdxgk_initial_component_state
    PVOID GraphicsDeviceHandle,
    PVOID PrivateHandle,
    ULONG ComponentIndex,
